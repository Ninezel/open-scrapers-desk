...
class SettingsStore:
  ...
  def load(self) -> AppSettings:
    ...
    return AppSettings(
      ...
      alert_webhook_url=normalize_url(raw.get("alert_webhook_url", "")),
      alert_discord_webhook_url=normalize_url(raw.get("alert_discord_webhook_url", "")),
      discord_format_preset=raw.get("discord_format_preset", "rich"),
  ...
  def save(self, settings: AppSettings) -> None:
    payload = {
      ...
      "alert_webhook_url": normalize_url(settings.alert_webhook_url),
      "alert_discord_webhook_url": normalize_url(settings.alert_discord_webhook_url),
      "discord_format_preset": settings.discord_format_preset,
